...
1. nums = [10, 8, 5, 3, 2], k = 3
   Score: 10 + 8 + 5 = 23

   Initial array: [10, 8, 5, 3, 2]
   k = 3 operations

    First Operation:

        Choose largest number: 10
        Add to score: score = 10
        Replace 10 with ceil(10/3) = 4
        Heap becomes: [8, 4, 5, 3, 2]

    Second Operation:

        Choose largest number: 8
        Add to score: score = 10 + 8 = 18
        Replace 8 with ceil(8/3) = 3
        Heap becomes: [5, 4, 3, 3, 2]

    Third Operation:

        Choose largest number: 5
        Add to score: score = 18 + 5 = 23
        Replace 5 with ceil(5/3) = 2
        Heap becomes: [4, 3, 3, 2, 2]
