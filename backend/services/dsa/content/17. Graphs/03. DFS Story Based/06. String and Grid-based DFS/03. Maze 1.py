...
Space Complexity: 
- DFS: O(mn) for the visited array and the recursion stack in the worst case.
...
class Solution:
    ...
    def DFS(self, maze: List[List[int]], x: int, y: int) -> bool:
        ...
        for dx, dy in self.directions:
            ...
            if not self.visited[x_][y_] and self.DFS(maze, x_, y_):
                return True
