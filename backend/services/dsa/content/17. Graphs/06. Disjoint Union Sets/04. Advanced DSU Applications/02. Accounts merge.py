...
This solution uses an enhanced Disjoint Set Union (DSU) data structure for efficient merging of accounts.
"""
import collections
...
class Solution:
    def accountsMerge(self, accounts: list[list[str]]) -> list[list[str]]:
        ...
        # Group emails by their final owner
        ...
        # Format the output
        result = []
        for account_index, emails in merged_accounts.items():
