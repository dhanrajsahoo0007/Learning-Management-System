...
// GetAll retrieves all system design topics
func (r *SystemDesignRepository) GetAll(ctx context.Context, isAITopic bool) ([]models.SystemDesignTopic, error) {
	query := `
	...
	rows, err := r.db.QueryContext(ctx, query, isAITopic)
	if err != nil {
